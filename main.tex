...
\section{Cycle of Cinder}
    \input{about_coc/0 intro}
    \input{about_coc/gameplay_core}
    \input{about_coc/gameplay_more}
    \input{about_coc/spielerfahrung}
    \input{about_coc/setting}
    \input{about_coc/prototype}
